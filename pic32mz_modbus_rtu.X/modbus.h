 ...
 * Author: thanho
 *
 * Created on September 26, 2025, 11:53 PM
 */
...
MODBUS_API void modbus_set_slave(modbus_t* ctx, int slave);
MODBUS_API int  modbus_get_slave(modbus_t* ctx);
MODBUS_API void modbus_set_byte_timeout(modbus_t* ctx, int timeout);
MODBUS_API int  modbus_get_byte_timeout(modbus_t* ctx);
MODBUS_API void modbus_set_debug(modbus_t* ctx, int flag);
